...
router.get('/casinos/paymentmethods', checkPermissions('manageCasinos'), (req, res) => {
  ...
  router.get('/casinos/paymentmethods/count', checkPermissions('manageCasinos'), (req, res) => {
    const userTenancy = req.session.user.tenancy;
  ...
  router.get('/casinos/paymentmethods/:id', checkPermissions('manageCasinos'), (req, res) => {
    const {
      id
    } = req.params;
    const userTenancy = req.session.user.tenancy;
  ...
  router.post('/casinos/paymentmethods/add', checkPermissions('manageCasinos'), (req, res) => {
    const {
      name,
      description,
      image,
  ...
  router.put('/casinos/paymentmethods/:id', checkPermissions('manageCasinos'), (req, res) => {
    const {
      userId
    } = req.session.user;
    const {
  ...
  router.post('/casinos/paymentmethods/:id/duplicate', checkPermissions('manageCasinos'), (req, res) => {
    const {
      userId
    } = req.session.user;
    const {
  ...
  router.delete('/casinos/paymentmethods/:id', checkPermissions('manageCasinos'), (req, res) => {
    const {
      id
    } = req.params;
